    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-8 animate-fade-in">
      <div className="w-full max-w-xs space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-bold text-stone-800 mb-2">加入心域</h1>
          <p className="text-stone-500 text-sm">开启你的情绪疗愈之旅</p>
        </div>
          ...
          <div className="space-y-4">
            <div className="relative group">
              <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                <UserIcon className="text-stone-300 group-focus-within:text-orange-400 transition-colors" size={20} />
              </div>
              <input
                type="text"
                value={username}
